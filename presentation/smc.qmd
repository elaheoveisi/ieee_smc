...
<img class="nostretch" src="assets/forest-plot-results.png" alt="Forest plots of estimated effects across Performance results (victims per step, total reward, saved victims) and Eye-tracking results (fixation duration, pupil-size SD, game-area fixation, chat-area fixation, fixation count, saccade count), each broken out by Novice/Expert and No LLM/LLM condition with significance annotations." style="display:block; width:auto; height:100%; max-width:100%; max-height:100%; object-fit:contain; margin:0; border-radius:0; box-shadow:none;">
</div>
```

---

## Reported [Effects]{.accent} {#reported-effects .effects-slide}
