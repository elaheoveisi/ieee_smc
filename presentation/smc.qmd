...
Manipulate guidance reliability and study how operators respond and calibrate trust when the LLM makes mistakes.
:::
::: {.card}
[Adaptive, workload-aware guidance]{.card-title}
Use performance and physiological signals to tailor assistance and reduce unnecessary cognitive demand.
:::
::: {.card}
[Situation awareness]{.card-title}
Embed cognitive-process measures to capture global and local awareness during LLM-supported decisions.
:::
::: {.card .secondary}
