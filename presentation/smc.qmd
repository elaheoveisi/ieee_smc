...
## How the LLM was [prompted]{.accent}
...
:::
::: {.column width="46%"}
**No coordinates, step counts, or visible reasoning.**
:::
:::
...
::: {.punchline}
A Tobii remote eye tracker was calibrated before the task; **LSL synchronized gaze, game events, player actions, and LLM message timing**.
:::
...
::: {.hook .center}
Attention moved toward the LLM guidance as engagement with the game decreased.
:::

---

## Guidance also changes [fixation and pupil behavior]{.accent}
...
- **Trust manipulation:** Study how operators respond when the LLM makes mistakes.
- **Workload-aware guidance:** Reduce unnecessary cognitive demand.
- **Situation awareness:** Embed cognitive-process measures in the task.
- **Adaptive LLM guidance:** Tailor assistance to the operator and context.
...
## [Future studies]{.accent}

::: {.cards}
::: {.card}
[Reliability]{.card-title}
Manipulate guidance reliability and evaluate trust calibration.
:::
::: {.card}
[Real-time adaptation]{.card-title}
Use performance and physiological signals to decide when assistance is needed.
:::
::: {.card}
[Situation awareness]{.card-title}
Measure global and local awareness during LLM-supported decisions.
:::
::: {.card .secondary}
